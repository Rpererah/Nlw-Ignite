...
const avaliableWeekDays = ['Domingo', 'Segunda', 'Terca', 'Quarta', 'Quinta', 'Sexta', 'Sabado'];
  ...
  return (
    <View className="flex-1 bg-background px-8 pt-16">
      ...
      contentContainerStyle={{paddingBottom:100}}>
       ...
       <TouchableOpacity className="flex-row w-100 h-14 items-center justify-center bg-green-600 rounded-md mt-6"
       activeOpacity={0.7}
