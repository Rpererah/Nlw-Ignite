...
export function NewHabitForm() {
    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <label htmlFor="" className="font-semibold leading-tight mt-4">Qual a recorrencia</label>
            ...
            <button type="submit" className="mt-6 rounded-lg p-4 flex items-center font-semibold bg-green-600 gap-3 justify-center hover:bg-green-500 border hover:border-green-400 transition-colors focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zinc-900 ">
